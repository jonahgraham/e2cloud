...
IMAGE_NAME="jonahkichwacoders/e2cloud-server"
...
# Use of folder
BUILD_ASSEMBLY_ZIP=$(echo ${DIR}/../../assembly/assembly-main/target/e2cloud-*.tar.gz)
LOCAL_ASSEMBLY_ZIP=${DIR}/e2cloud.tar.gz
